...
export default function NavItem({ category, handleOpen, isOpen, isAnyOpen }: NavItemsProps) {
    return (
        <div className='flex'>
                                            ...
                                            category.featured.map((item) => (
                                                <div key={item.name} className='group relative text-base sm:text-sm'>
                                                    <div className='relative aspect-video overflow-hidden rounded-lg bg-gray-100 group-hover:opacity-75'>
                                                        <Image src={item.imageSrc} alt='category-image' fill className='object-cover object-center' />
                                                    </div>
